...
[**get_items_by_id_by_mediasourceid_subtitles_by_index_by_format**](SubtitleServiceApi.md#get_items_by_id_by_mediasourceid_subtitles_by_index_by_format) | **GET** /Items/{Id}/{MediaSourceId}/Subtitles/{Index}/Stream.{Format} | Gets subtitles in a specified format.
[**get_items_by_id_by_mediasourceid_subtitles_by_index_by_startpositionticks_by_format**](SubtitleServiceApi.md#get_items_by_id_by_mediasourceid_subtitles_by_index_by_startpositionticks_by_format) | **GET** /Items/{Id}/{MediaSourceId}/Subtitles/{Index}/{StartPositionTicks}/Stream.{Format} | Gets subtitles in a specified format.
...
# **get_items_by_id_by_mediasourceid_subtitles_by_index_by_format**
> get_items_by_id_by_mediasourceid_subtitles_by_index_by_format(id, media_source_id, index, format, start_position_ticks=start_position_ticks, end_position_ticks=end_position_ticks, copy_timestamps=copy_timestamps)
...
try:
    # Gets subtitles in a specified format.
    api_instance.get_items_by_id_by_mediasourceid_subtitles_by_index_by_format(id, media_source_id, index, format, start_position_ticks=start_position_ticks, end_position_ticks=end_position_ticks, copy_timestamps=copy_timestamps)
except ApiException as e:
    print("Exception when calling SubtitleServiceApi->get_items_by_id_by_mediasourceid_subtitles_by_index_by_format: %s\n" % e)
```
...
# **get_items_by_id_by_mediasourceid_subtitles_by_index_by_startpositionticks_by_format**
> get_items_by_id_by_mediasourceid_subtitles_by_index_by_startpositionticks_by_format(id, media_source_id, index, format, start_position_ticks, end_position_ticks=end_position_ticks, copy_timestamps=copy_timestamps)
...
try:
    # Gets subtitles in a specified format.
    api_instance.get_items_by_id_by_mediasourceid_subtitles_by_index_by_startpositionticks_by_format(id, media_source_id, index, format, start_position_ticks, end_position_ticks=end_position_ticks, copy_timestamps=copy_timestamps)
except ApiException as e:
    print("Exception when calling SubtitleServiceApi->get_items_by_id_by_mediasourceid_subtitles_by_index_by_startpositionticks_by_format: %s\n" % e)
```
