...
class TestPlaystateServiceApi(unittest.TestCase):
    ...
    def test_post_users_by_userid_items_by_itemid_userdata(self):
    ...
    def test_post_users_by_userid_playeditems_by_id_delete(self):
    ...
    def test_post_users_by_userid_playingitems_by_id_delete(self):
