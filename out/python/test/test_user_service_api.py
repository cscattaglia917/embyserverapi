...
class TestUserServiceApi(unittest.TestCase):
    ...
    def test_delete_users_by_id_trackselections_by_tracktype(self):
    ...
    def test_get_users_prefixes(self):
    ...
    def test_post_users_by_id_delete(self):
    ...
    def test_post_users_by_id_trackselections_by_tracktype_delete(self):
