...
class TestSystemServiceApi(unittest.TestCase):
    ...
    def test_get_system_logs_by_name(self):
    ...
    def test_get_system_logs_by_name_lines(self):
    ...
    def test_get_system_logs_query(self):
    ...
    def test_get_system_releasenotes(self):
    ...
    def test_get_system_releasenotes_versions(self):
