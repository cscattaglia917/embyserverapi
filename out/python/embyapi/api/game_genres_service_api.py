...
class GameGenresServiceApi(object):
    ...
    def get_gamegenres(self, **kwargs):  # noqa: E501
        """Gets all Game genres from a given item, folder, or the entire library  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_gamegenres(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.get_gamegenres_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_gamegenres_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_gamegenres_with_http_info(self, **kwargs):  # noqa: E501
        """Gets all Game genres from a given item, folder, or the entire library  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_gamegenres_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def get_gamegenres_by_name(self, name, **kwargs):  # noqa: E501
        """Gets a Game genre, by name  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_gamegenres_by_name(name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_gamegenres_by_name_with_http_info(name, **kwargs)  # noqa: E501
        else:
            (data) = self.get_gamegenres_by_name_with_http_info(name, **kwargs)  # noqa: E501
            return data

    def get_gamegenres_by_name_with_http_info(self, name, **kwargs):  # noqa: E501
        """Gets a Game genre, by name  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_gamegenres_by_name_with_http_info(name, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_gamegenres_by_name" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('name' not in params or
                params['name'] is None):
            raise ValueError("Missing the required parameter `name` when calling `get_gamegenres_by_name`")  # noqa: E501
