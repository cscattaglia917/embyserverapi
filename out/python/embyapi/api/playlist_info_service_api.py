...
class PlaylistInfoServiceApi(object):
    ...
    def post_smartplaylist_explain_rules(self, body, **kwargs):  # noqa: E501
        """post_smartplaylist_explain_rules  # noqa: E501

        No authentication required  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_smartplaylist_explain_rules(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param SmartPlaylistContractsSmartPlaylistDto body: SmartPlaylistDto:  (required)
        :return: SmartPlaylistContractsResponseDtoSmartPlaylistContractsHierarchyStringDto
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_smartplaylist_explain_rules_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.post_smartplaylist_explain_rules_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def post_smartplaylist_explain_rules_with_http_info(self, body, **kwargs):  # noqa: E501
        """post_smartplaylist_explain_rules  # noqa: E501

        No authentication required  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_smartplaylist_explain_rules_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_smartplaylist_explain_rules" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_smartplaylist_explain_rules`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/smartplaylist/explain_rules', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='SmartPlaylistContractsResponseDtoSmartPlaylistContractsHierarchyStringDto',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
