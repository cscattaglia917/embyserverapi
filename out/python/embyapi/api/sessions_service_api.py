...
class SessionsServiceApi(object):
    ...
    def get_sessions_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['controllable_by_user_id', 'device_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def post_sessions_by_id_playing(self, body, item_ids, play_command, id, **kwargs):  # noqa: E501
        ...
        :param str play_command: The type of play command to issue (PlayNow, PlayNext, PlayLast). Clients who have not yet implemented play next and play last may play now. (required)
        :param str id: Session Id (required)
    ...
    def post_sessions_capabilities(self, id, **kwargs):  # noqa: E501
        ...
        :param bool supports_persistent_identifier: Determines whether the device supports a unique identifier.
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def post_sessions_capabilities_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        all_params = ['id', 'playable_media_types', 'supported_commands', 'supports_media_control', 'supports_sync', 'supports_persistent_identifier']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'supports_persistent_identifier' in params:
            query_params.append(('SupportsPersistentIdentifier', params['supports_persistent_identifier']))  # noqa: E501
