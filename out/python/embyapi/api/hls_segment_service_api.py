...
class HlsSegmentServiceApi(object):
    ...
    def get_videos_by_id_hls_by_playlistid_by_segmentid_by_segmentcontainer(self, playlist_id, segment_id, segment_container, id, container, **kwargs):  # noqa: E501
        """get_videos_by_id_hls_by_playlistid_by_segmentid_by_segmentcontainer  # noqa: E501

        No authentication required  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_videos_by_id_hls_by_playlistid_by_segmentid_by_segmentcontainer(playlist_id, segment_id, segment_container, id, container, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str playlist_id: (required)
        :param str segment_id: SegmentId (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_videos_by_id_hls_by_playlistid_by_segmentid_by_segmentcontainer_with_http_info(playlist_id, segment_id, segment_container, id, container, **kwargs)  # noqa: E501
        else:
            (data) = self.get_videos_by_id_hls_by_playlistid_by_segmentid_by_segmentcontainer_with_http_info(playlist_id, segment_id, segment_container, id, container, **kwargs)  # noqa: E501
            return data

    def get_videos_by_id_hls_by_playlistid_by_segmentid_by_segmentcontainer_with_http_info(self, playlist_id, segment_id, segment_container, id, container, **kwargs):  # noqa: E501
        """get_videos_by_id_hls_by_playlistid_by_segmentid_by_segmentcontainer  # noqa: E501

        No authentication required  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_videos_by_id_hls_by_playlistid_by_segmentid_by_segmentcontainer_with_http_info(playlist_id, segment_id, segment_container, id, container, async_req=True)
        >>> result = thread.get()
        ...
        if ('container' not in params or
            ...
            raise ValueError("Missing the required parameter `container` when calling `get_videos_by_id_hls_by_playlistid_by_segmentid_by_segmentcontainer`")  # noqa: E501
