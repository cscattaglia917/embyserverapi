...
class UserActivityAPIApi(object):
    ...
    def get_user_usage_stats_get_item_path(self, id, **kwargs):  # noqa: E501
        """Get a list of items for type and filtered  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_user_usage_stats_get_item_path(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_user_usage_stats_get_item_path_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_user_usage_stats_get_item_path_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def get_user_usage_stats_get_item_path_with_http_info(self, id, **kwargs):  # noqa: E501
        """Get a list of items for type and filtered  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_user_usage_stats_get_item_path_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_user_usage_stats_get_item_path" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_user_usage_stats_get_item_path`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/user_usage_stats/get_item_path', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_user_usage_stats_get_item_stats(self, id, **kwargs):  # noqa: E501
        """Get a list of items for type and filtered  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_user_usage_stats_get_item_stats(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_user_usage_stats_get_item_stats_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_user_usage_stats_get_item_stats_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def get_user_usage_stats_get_item_stats_with_http_info(self, id, **kwargs):  # noqa: E501
        """Get a list of items for type and filtered  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_user_usage_stats_get_item_stats_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_user_usage_stats_get_item_stats" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_user_usage_stats_get_item_stats`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/user_usage_stats/get_item_stats', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_user_usage_stats_get_items(self, **kwargs):  # noqa: E501
        """Get a list of items for type and filtered  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_user_usage_stats_get_items(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str filter: filter string
        :param str item_type: type of items to return
        :param int parent: parentid
        :return: object
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_user_usage_stats_get_items_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_user_usage_stats_get_items_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_user_usage_stats_get_items_with_http_info(self, **kwargs):  # noqa: E501
        """Get a list of items for type and filtered  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_user_usage_stats_get_items_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['filter', 'item_type', 'parent']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_user_usage_stats_get_items" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/user_usage_stats/get_items', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_user_usage_stats_userplaylist_with_http_info(self, user_id, aggregate_data, **kwargs):  # noqa: E501
        ...
        if ('aggregate_data' not in params or
                params['aggregate_data'] is None):
