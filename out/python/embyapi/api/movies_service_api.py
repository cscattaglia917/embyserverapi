...
class MoviesServiceApi(object):
    ...
    def get_movies_recommendations(self, **kwargs):  # noqa: E501
        """Gets movie recommendations  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_movies_recommendations(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int category_limit: The max number of categories to return
        :param int item_limit: The max number of items to return per category
        ...
        if kwargs.get('async_req'):
            return self.get_movies_recommendations_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_movies_recommendations_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_movies_recommendations_with_http_info(self, **kwargs):  # noqa: E501
        """Gets movie recommendations  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_movies_recommendations_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['category_limit', 'item_limit', 'user_id', 'parent_id', 'enable_images', 'enable_user_data', 'image_type_limit', 'enable_image_types']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_movies_recommendations" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        query_params = []
        if 'category_limit' in params:
            query_params.append(('CategoryLimit', params['category_limit']))  # noqa: E501
        if 'item_limit' in params:
            query_params.append(('ItemLimit', params['item_limit']))  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='list[RecommendationDto]',  # noqa: E501
