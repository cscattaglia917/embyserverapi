...
class ArtistsServiceApi(object):
    ...
    def get_artists(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.get_artists_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_artists_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_artists_with_http_info(self, **kwargs):  # noqa: E501
        """Gets all artists from a given item, folder, or the entire library  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_artists_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def get_artists_albumartists(self, **kwargs):  # noqa: E501
        """Gets all album artists from a given item, folder, or the entire library  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_artists_albumartists(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_artists_albumartists_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_artists_albumartists_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_artists_albumartists_with_http_info(self, **kwargs):  # noqa: E501
        """Gets all album artists from a given item, folder, or the entire library  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_artists_albumartists_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_artists_albumartists" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def get_artists_by_name(self, name, **kwargs):  # noqa: E501
        """Gets an artist, by name  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_artists_by_name(name, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str name: The artist name (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_artists_by_name_with_http_info(name, **kwargs)  # noqa: E501
        else:
            (data) = self.get_artists_by_name_with_http_info(name, **kwargs)  # noqa: E501
            return data

    def get_artists_by_name_with_http_info(self, name, **kwargs):  # noqa: E501
        """Gets an artist, by name  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_artists_by_name_with_http_info(name, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_artists_by_name" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('name' not in params or
                params['name'] is None):
            raise ValueError("Missing the required parameter `name` when calling `get_artists_by_name`")  # noqa: E501
