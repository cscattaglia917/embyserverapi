...
class PlaystateServiceApi(object):
    ...
    def post_users_by_userid_playingitems_by_id_progress(self, user_id, id, media_source_id, **kwargs):  # noqa: E501
        """Reports a user's playback progress  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_users_by_userid_playingitems_by_id_progress(user_id, id, media_source_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_users_by_userid_playingitems_by_id_progress_with_http_info(user_id, id, media_source_id, **kwargs)  # noqa: E501
        else:
            (data) = self.post_users_by_userid_playingitems_by_id_progress_with_http_info(user_id, id, media_source_id, **kwargs)  # noqa: E501
            return data

    def post_users_by_userid_playingitems_by_id_progress_with_http_info(self, user_id, id, media_source_id, **kwargs):  # noqa: E501
        """Reports a user's playback progress  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_users_by_userid_playingitems_by_id_progress_with_http_info(user_id, id, media_source_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['user_id', 'id', 'media_source_id', 'position_ticks', 'is_paused', 'is_muted', 'audio_stream_index', 'subtitle_stream_index', 'volume_level', 'play_method', 'live_stream_id', 'play_session_id', 'repeat_mode']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
