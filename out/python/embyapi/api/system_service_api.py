...
class SystemServiceApi(object):
    ...
    def get_system_logs_by_name(self, name, **kwargs):  # noqa: E501
        """Gets a log file  # noqa: E501

        Requires authentication as administrator  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_system_logs_by_name(name, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str name: The log file name. (required)
        :param bool sanitize: Return sanitized log
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_system_logs_by_name_with_http_info(name, **kwargs)  # noqa: E501
        else:
            (data) = self.get_system_logs_by_name_with_http_info(name, **kwargs)  # noqa: E501
            return data

    def get_system_logs_by_name_with_http_info(self, name, **kwargs):  # noqa: E501
        """Gets a log file  # noqa: E501

        Requires authentication as administrator  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_system_logs_by_name_with_http_info(name, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['name', 'sanitize']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_system_logs_by_name" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('name' not in params or
                params['name'] is None):
            raise ValueError("Missing the required parameter `name` when calling `get_system_logs_by_name`")  # noqa: E501
        ...
        if 'sanitize' in params:
            query_params.append(('Sanitize', params['sanitize']))  # noqa: E501
    ...
    def get_system_logs_by_name_lines(self, name, **kwargs):  # noqa: E501
        """Gets a log file  # noqa: E501

        Requires authentication as administrator  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_system_logs_by_name_lines(name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_system_logs_by_name_lines_with_http_info(name, **kwargs)  # noqa: E501
        else:
            (data) = self.get_system_logs_by_name_lines_with_http_info(name, **kwargs)  # noqa: E501
            return data

    def get_system_logs_by_name_lines_with_http_info(self, name, **kwargs):  # noqa: E501
        """Gets a log file  # noqa: E501

        Requires authentication as administrator  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_system_logs_by_name_lines_with_http_info(name, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_system_logs_by_name_lines" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'name' is set
        if ('name' not in params or
                params['name'] is None):
            raise ValueError("Missing the required parameter `name` when calling `get_system_logs_by_name_lines`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='QueryResultString',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_system_logs_query(self, **kwargs):  # noqa: E501
        """Gets a list of available server log files  # noqa: E501

        Requires authentication as administrator  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_system_logs_query(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_system_logs_query_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_system_logs_query_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_system_logs_query_with_http_info(self, **kwargs):  # noqa: E501
        """Gets a list of available server log files  # noqa: E501

        Requires authentication as administrator  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_system_logs_query_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_system_logs_query" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='QueryResultLogFile',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_system_releasenotes(self, **kwargs):  # noqa: E501
        """Gets release notes  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_system_releasenotes(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_system_releasenotes_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_system_releasenotes_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_system_releasenotes_with_http_info(self, **kwargs):  # noqa: E501
        """Gets release notes  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_system_releasenotes_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_system_releasenotes" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def get_system_releasenotes_versions(self, **kwargs):  # noqa: E501
        """Gets release notes  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_system_releasenotes_versions(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_system_releasenotes_versions_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_system_releasenotes_versions_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_system_releasenotes_versions_with_http_info(self, **kwargs):  # noqa: E501
        """Gets release notes  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_system_releasenotes_versions_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_system_releasenotes_versions" % key
                )
            params[key] = val
        del params['kwargs']
