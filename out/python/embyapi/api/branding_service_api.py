...
class BrandingServiceApi(object):
    ...
    def get_branding_configuration(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.get_branding_configuration_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_branding_configuration_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def get_branding_configuration_with_http_info(self, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_branding_configuration" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            response_type='BrandingBrandingOptions',  # noqa: E501
    ...
    def get_branding_css(self, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_branding_css_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_branding_css_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def get_branding_css_with_http_info(self, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_branding_css" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def get_branding_css_css(self, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_branding_css_css_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_branding_css_css_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def get_branding_css_css_with_http_info(self, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_branding_css_css" % key
                )
            params[key] = val
        del params['kwargs']
