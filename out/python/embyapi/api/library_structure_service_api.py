...
class LibraryStructureServiceApi(object):
    ...
    def get_library_virtualfolders(self, **kwargs):  # noqa: E501
        """get_library_virtualfolders  # noqa: E501

        Requires authentication as administrator  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_library_virtualfolders(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_library_virtualfolders_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_library_virtualfolders_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_library_virtualfolders_with_http_info(self, **kwargs):  # noqa: E501
        """get_library_virtualfolders  # noqa: E501

        Requires authentication as administrator  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_library_virtualfolders_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_library_virtualfolders" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[VirtualFolderInfo]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
