...
class UserViewsServiceApi(object):
    ...
    def get_users_by_userid_groupingoptions(self, user_id, **kwargs):  # noqa: E501
        """get_users_by_userid_groupingoptions  # noqa: E501

        No authentication required  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_users_by_userid_groupingoptions(user_id, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.get_users_by_userid_groupingoptions_with_http_info(user_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_users_by_userid_groupingoptions_with_http_info(user_id, **kwargs)  # noqa: E501
            return data

    def get_users_by_userid_groupingoptions_with_http_info(self, user_id, **kwargs):  # noqa: E501
        """get_users_by_userid_groupingoptions  # noqa: E501

        No authentication required  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_users_by_userid_groupingoptions_with_http_info(user_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_users_by_userid_groupingoptions" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('user_id' not in params or
            ...
            raise ValueError("Missing the required parameter `user_id` when calling `get_users_by_userid_groupingoptions`")  # noqa: E501
