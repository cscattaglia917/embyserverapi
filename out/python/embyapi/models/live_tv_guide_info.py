...
class LiveTvGuideInfo(object):
    ...
    def __init__(self, start_date=None, end_date=None):  # noqa: E501
        """LiveTvGuideInfo - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LiveTvGuideInfo, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LiveTvGuideInfo):
            return False
