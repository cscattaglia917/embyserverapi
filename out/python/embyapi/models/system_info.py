...
class SystemInfo(object):
    ...
    def system_update_level(self, system_update_level):
        ...
        if system_update_level not in allowed_values:
            raise ValueError(
                "Invalid value for `system_update_level` ({0}), must be one of {1}"  # noqa: E501
                .format(system_update_level, allowed_values)
            )
