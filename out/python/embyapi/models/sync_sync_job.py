...
class SyncSyncJob(object):
    ...
    def status(self, status):
        ...
        :type: str
        """
        allowed_values = ["Queued", "Converting", "ReadyToTransfer", "Transferring", "Completed", "CompletedWithError", "Failed"]  # noqa: E501
