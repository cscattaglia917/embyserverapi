...
class EmbyMediaModelEnumsVideoMediaTypes(object):
    ...
    def __init__(self):  # noqa: E501
        """EmbyMediaModelEnumsVideoMediaTypes - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EmbyMediaModelEnumsVideoMediaTypes, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EmbyMediaModelEnumsVideoMediaTypes):
            return False
