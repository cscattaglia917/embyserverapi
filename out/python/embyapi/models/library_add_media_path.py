...
class LibraryAddMediaPath(object):
    ...
    def __init__(self, name=None, path=None, path_info=None, refresh_library=None):  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this LibraryAddMediaPath.  # noqa: E501


        :return: The name of this LibraryAddMediaPath.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this LibraryAddMediaPath.


        :param name: The name of this LibraryAddMediaPath.  # noqa: E501
        :type: str
        """
