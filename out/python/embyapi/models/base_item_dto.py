...
class BaseItemDto(object):
    ...
    def locked_fields(self, locked_fields):
        ...
        :type: list[str]
        """
        allowed_values = ["Cast", "Genres", "ProductionLocations", "Studios", "Tags", "Name", "Overview", "Runtime", "OfficialRating", "Collections", "ChannelNumber", "SortName", "OriginalTitle"]  # noqa: E501
