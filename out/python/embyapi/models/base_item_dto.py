...
class BaseItemDto(object):
    ...
    swagger_types = {
        ...
        'display_specials_with_seasons': 'bool',
        'can_delete': 'bool',
        'can_download': 'bool',
        'has_subtitles': 'bool',
    ...
    attribute_map = {
        ...
        'display_specials_with_seasons': 'DisplaySpecialsWithSeasons',
    ...
    def __init__(self, name=None, original_title=None, server_id=None, id=None, etag=None, playlist_item_id=None, date_created=None, extra_type=None, airs_before_season_number=None, airs_after_season_number=None, airs_before_episode_number=None, display_specials_with_seasons=None, can_delete=None, can_download=None, has_subtitles=None, supports_resume=None, preferred_metadata_language=None, preferred_metadata_country_code=None, supports_sync=None, container=None, sort_name=None, forced_sort_name=None, video3_d_format=None, premiere_date=None, external_urls=None, media_sources=None, critic_rating=None, game_system_id=None, game_system=None, production_locations=None, path=None, official_rating=None, custom_rating=None, channel_id=None, channel_name=None, overview=None, taglines=None, genres=None, community_rating=None, run_time_ticks=None, play_access=None, aspect_ratio=None, production_year=None, number=None, channel_number=None, index_number=None, index_number_end=None, parent_index_number=None, remote_trailers=None, provider_ids=None, is_folder=None, parent_id=None, type=None, people=None, studios=None, genre_items=None, parent_logo_item_id=None, parent_backdrop_item_id=None, parent_backdrop_image_tags=None, local_trailer_count=None, user_data=None, recursive_item_count=None, child_count=None, series_name=None, series_id=None, season_id=None, special_feature_count=None, display_preferences_id=None, status=None, air_time=None, air_days=None, tags=None, primary_image_aspect_ratio=None, artists=None, artist_items=None, album=None, collection_type=None, display_order=None, album_id=None, album_primary_image_tag=None, series_primary_image_tag=None, album_artist=None, album_artists=None, season_name=None, media_streams=None, part_count=None, image_tags=None, backdrop_image_tags=None, parent_logo_image_tag=None, parent_art_item_id=None, parent_art_image_tag=None, series_thumb_image_tag=None, series_studio=None, parent_thumb_item_id=None, parent_thumb_image_tag=None, parent_primary_image_item_id=None, parent_primary_image_tag=None, chapters=None, location_type=None, media_type=None, end_date=None, locked_fields=None, lock_data=None, width=None, height=None, camera_make=None, camera_model=None, software=None, exposure_time=None, focal_length=None, image_orientation=None, aperture=None, shutter_speed=None, latitude=None, longitude=None, altitude=None, iso_speed_rating=None, series_timer_id=None, channel_primary_image_tag=None, start_date=None, completion_percentage=None, is_repeat=None, is_new=None, episode_title=None, is_movie=None, is_sports=None, is_series=None, is_live=None, is_news=None, is_kids=None, is_premiere=None, timer_id=None, current_program=None, movie_count=None, series_count=None, album_count=None, song_count=None, music_video_count=None):  # noqa: E501
        ...
        self._display_specials_with_seasons = None
        ...
        self._parent_art_item_id = None
        self._parent_art_image_tag = None
        self._series_thumb_image_tag = None
        ...
        if display_specials_with_seasons is not None:
            self.display_specials_with_seasons = display_specials_with_seasons
        ...
        if parent_art_item_id is not None:
            self.parent_art_item_id = parent_art_item_id
        if parent_art_image_tag is not None:
            self.parent_art_image_tag = parent_art_image_tag
        if series_thumb_image_tag is not None:
    ...
    @property
    def display_specials_with_seasons(self):
        """Gets the display_specials_with_seasons of this BaseItemDto.  # noqa: E501


        :return: The display_specials_with_seasons of this BaseItemDto.  # noqa: E501
        :rtype: bool
        """
        return self._display_specials_with_seasons

    @display_specials_with_seasons.setter
    def display_specials_with_seasons(self, display_specials_with_seasons):
        """Sets the display_specials_with_seasons of this BaseItemDto.


        :param display_specials_with_seasons: The display_specials_with_seasons of this BaseItemDto.  # noqa: E501
        :type: bool
        """

        self._display_specials_with_seasons = display_specials_with_seasons
    ...
    def has_subtitles(self):
        """Gets the has_subtitles of this BaseItemDto.  # noqa: E501


        :return: The has_subtitles of this BaseItemDto.  # noqa: E501
        :rtype: bool
        """
    ...
    def video3_d_format(self, video3_d_format):
        ...
        :type: str
        """
        allowed_values = ["HalfSideBySide", "FullSideBySide", "FullTopAndBottom", "HalfTopAndBottom", "MVC"]  # noqa: E501
        if video3_d_format not in allowed_values:
            raise ValueError(
                "Invalid value for `video3_d_format` ({0}), must be one of {1}"  # noqa: E501
                .format(video3_d_format, allowed_values)
            )
    ...
    def play_access(self, play_access):
        ...
        if play_access not in allowed_values:
            raise ValueError(
                "Invalid value for `play_access` ({0}), must be one of {1}"  # noqa: E501
                .format(play_access, allowed_values)
            )
    ...
    def aspect_ratio(self):
        """Gets the aspect_ratio of this BaseItemDto.  # noqa: E501


        :return: The aspect_ratio of this BaseItemDto.  # noqa: E501
        :rtype: str
        """
    ...
    @property
    def air_time(self):
        """Gets the air_time of this BaseItemDto.  # noqa: E501


        :return: The air_time of this BaseItemDto.  # noqa: E501
        :rtype: str
        """
    ...
    def air_days(self, air_days):
        ...
        if not set(air_days).issubset(set(allowed_values)):
            raise ValueError(
                "Invalid values for `air_days` [{0}], must be a subset of [{1}]"  # noqa: E501
                .format(", ".join(map(str, set(air_days) - set(allowed_values))),  # noqa: E501
    ...
    def parent_art_item_id(self):
        """Gets the parent_art_item_id of this BaseItemDto.  # noqa: E501


        :return: The parent_art_item_id of this BaseItemDto.  # noqa: E501
        :rtype: str
        """
    ...
    def parent_art_image_tag(self):
        """Gets the parent_art_image_tag of this BaseItemDto.  # noqa: E501


        :return: The parent_art_image_tag of this BaseItemDto.  # noqa: E501
        :rtype: str
        """
    ...
    def series_thumb_image_tag(self):
        """Gets the series_thumb_image_tag of this BaseItemDto.  # noqa: E501


        :return: The series_thumb_image_tag of this BaseItemDto.  # noqa: E501
        :rtype: str
        """
    ...
    def parent_primary_image_item_id(self):
        """Gets the parent_primary_image_item_id of this BaseItemDto.  # noqa: E501


        :return: The parent_primary_image_item_id of this BaseItemDto.  # noqa: E501
        :rtype: str
        """
    ...
    def parent_primary_image_tag(self):
        """Gets the parent_primary_image_tag of this BaseItemDto.  # noqa: E501


        :return: The parent_primary_image_tag of this BaseItemDto.  # noqa: E501
        :rtype: str
        """
    ...
    def location_type(self, location_type):
        ...
        :type: str
        """
        allowed_values = ["FileSystem", "Virtual"]  # noqa: E501
    ...
    def locked_fields(self, locked_fields):
        ...
        :type: list[str]
        """
        allowed_values = ["Cast", "Genres", "ProductionLocations", "Studios", "Tags", "Name", "Overview", "Runtime", "OfficialRating"]  # noqa: E501
        if not set(locked_fields).issubset(set(allowed_values)):
            raise ValueError(
                "Invalid values for `locked_fields` [{0}], must be a subset of [{1}]"  # noqa: E501
                .format(", ".join(map(str, set(locked_fields) - set(allowed_values))),  # noqa: E501
                        ", ".join(map(str, allowed_values)))
            )
    ...
    def image_orientation(self, image_orientation):
        ...
        :type: str
        """
        allowed_values = ["TopLeft", "TopRight", "BottomRight", "BottomLeft", "LeftTop", "RightTop", "RightBottom", "LeftBottom"]  # noqa: E501
        if image_orientation not in allowed_values:
            raise ValueError(
                "Invalid value for `image_orientation` ({0}), must be one of {1}"  # noqa: E501
                .format(image_orientation, allowed_values)
            )
