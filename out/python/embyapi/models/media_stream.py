...
class MediaStream(object):
    ...
    def type(self, type):
        ...
        :type: str
        """
        allowed_values = ["Unknown", "Audio", "Video", "Subtitle", "EmbeddedImage", "Attachment", "Data"]  # noqa: E501
    ...
    def delivery_method(self, delivery_method):
        ...
        :type: str
        """
        allowed_values = ["Encode", "Embed", "External", "Hls", "VideoSideData"]  # noqa: E501
    ...
    def subtitle_location_type(self, subtitle_location_type):
        ...
        :type: str
        """
        allowed_values = ["InternalStream", "VideoSideData"]  # noqa: E501
        if subtitle_location_type not in allowed_values:
            raise ValueError(
                "Invalid value for `subtitle_location_type` ({0}), must be one of {1}"  # noqa: E501
                .format(subtitle_location_type, allowed_values)
            )
