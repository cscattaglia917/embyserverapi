...
class LibraryLibraryTypeOptions(object):
    ...
    def supported_image_types(self, supported_image_types):
        ...
        if not set(supported_image_types).issubset(set(allowed_values)):
            raise ValueError(
                "Invalid values for `supported_image_types` [{0}], must be a subset of [{1}]"  # noqa: E501
                .format(", ".join(map(str, set(supported_image_types) - set(allowed_values))),  # noqa: E501
