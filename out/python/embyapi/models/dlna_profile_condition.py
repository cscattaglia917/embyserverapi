...
class DlnaProfileCondition(object):
    ...
    def condition(self, condition):
        ...
        :type: str
        """
        allowed_values = ["Equals", "NotEquals", "LessThanEqual", "GreaterThanEqual", "EqualsAny"]  # noqa: E501
    ...
    def _property(self, _property):
        ...
        :type: str
        """
        allowed_values = ["AudioChannels", "AudioBitrate", "AudioProfile", "Width", "Height", "Has64BitOffsets", "PacketLength", "VideoBitDepth", "VideoBitrate", "VideoFramerate", "VideoLevel", "VideoProfile", "VideoTimestamp", "IsAnamorphic", "RefFrames", "NumAudioStreams", "NumVideoStreams", "IsSecondaryAudio", "VideoCodecTag", "IsAvc", "IsInterlaced", "AudioSampleRate", "AudioBitDepth"]  # noqa: E501
