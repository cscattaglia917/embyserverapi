...
class ImageProviderInfo(object):
    ...
    def supported_images(self, supported_images):
        ...
        if not set(supported_images).issubset(set(allowed_values)):
            raise ValueError(
                "Invalid values for `supported_images` [{0}], must be a subset of [{1}]"  # noqa: E501
                .format(", ".join(map(str, set(supported_images) - set(allowed_values))),  # noqa: E501
