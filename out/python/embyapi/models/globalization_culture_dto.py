...
class GlobalizationCultureDto(object):
    ...
    def __init__(self, name=None, display_name=None, two_letter_iso_language_name=None, three_letter_iso_language_name=None, three_letter_iso_language_names=None):  # noqa: E501
