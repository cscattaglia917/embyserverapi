...
class LiveTvKeywordInfo(object):
    ...
    def keyword_type(self, keyword_type):
        ...
        :type: str
        """
        allowed_values = ["Name", "EpisodeTitle", "Overview", "Actor", "Director"]  # noqa: E501
        if keyword_type not in allowed_values:
            raise ValueError(
                "Invalid value for `keyword_type` ({0}), must be one of {1}"  # noqa: E501
                .format(keyword_type, allowed_values)
            )
