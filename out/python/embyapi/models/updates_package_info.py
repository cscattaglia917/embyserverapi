...
class UpdatesPackageInfo(object):
    ...
    def target_system(self, target_system):
        ...
        :type: str
        """
        allowed_values = ["Server", "MBTheater", "MBClassic", "Other"]  # noqa: E501
        if target_system not in allowed_values:
            raise ValueError(
                "Invalid value for `target_system` ({0}), must be one of {1}"  # noqa: E501
                .format(target_system, allowed_values)
            )
