...
class DisplayPreferences(object):
    ...
    def __init__(self, id=None, view_type=None, sort_by=None, index_by=None, remember_indexing=None, primary_image_height=None, primary_image_width=None, custom_prefs=None, scroll_direction=None, show_backdrop=None, remember_sorting=None, sort_order=None, show_sidebar=None, client=None):  # noqa: E501
    ...
    def scroll_direction(self, scroll_direction):
        ...
        if scroll_direction not in allowed_values:
            raise ValueError(
                "Invalid value for `scroll_direction` ({0}), must be one of {1}"  # noqa: E501
                .format(scroll_direction, allowed_values)
            )
    ...
    def show_sidebar(self):
        """Gets the show_sidebar of this DisplayPreferences.  # noqa: E501


        :return: The show_sidebar of this DisplayPreferences.  # noqa: E501
        :rtype: bool
        """
    ...
    def show_sidebar(self, show_sidebar):
        """Sets the show_sidebar of this DisplayPreferences.


        :param show_sidebar: The show_sidebar of this DisplayPreferences.  # noqa: E501
        :type: bool
        """
