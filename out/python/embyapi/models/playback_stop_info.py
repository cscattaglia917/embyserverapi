...
class PlaybackStopInfo(object):
    ...
    def __init__(self, now_playing_queue=None, playlist_item_id=None, item=None, item_id=None, session_id=None, media_source_id=None, position_ticks=None, live_stream_id=None, play_session_id=None, failed=None, next_media_type=None):  # noqa: E501
