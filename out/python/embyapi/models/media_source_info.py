...
class MediaSourceInfo(object):
    ...
    def __init__(self, protocol=None, id=None, path=None, encoder_path=None, encoder_protocol=None, type=None, container=None, size=None, name=None, is_remote=None, run_time_ticks=None, supports_transcoding=None, supports_direct_stream=None, supports_direct_play=None, is_infinite_stream=None, requires_opening=None, open_token=None, requires_closing=None, live_stream_id=None, buffer_ms=None, requires_looping=None, supports_probing=None, video3_d_format=None, media_streams=None, formats=None, bitrate=None, timestamp=None, required_http_headers=None, transcoding_url=None, transcoding_sub_protocol=None, transcoding_container=None, analyze_duration_ms=None, read_at_native_framerate=None, default_audio_stream_index=None, default_subtitle_stream_index=None):  # noqa: E501
    ...
    def encoder_protocol(self, encoder_protocol):
        ...
        """
        allowed_values = ["File", "Http", "Rtmp", "Rtsp", "Udp", "Rtp", "Ftp", "Mms"]  # noqa: E501
        if encoder_protocol not in allowed_values:
            raise ValueError(
                "Invalid value for `encoder_protocol` ({0}), must be one of {1}"  # noqa: E501
                .format(encoder_protocol, allowed_values)
            )
    ...
    def type(self, type):
        ...
        :type: str
        """
        allowed_values = ["Default", "Grouping", "Placeholder"]  # noqa: E501
    ...
    def timestamp(self, timestamp):
        ...
        :type: str
        """
        allowed_values = ["None", "Zero", "Valid"]  # noqa: E501
        if timestamp not in allowed_values:
            raise ValueError(
                "Invalid value for `timestamp` ({0}), must be one of {1}"  # noqa: E501
                .format(timestamp, allowed_values)
            )
