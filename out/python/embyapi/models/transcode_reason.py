...
class TranscodeReason(object):
    ...
    def __init__(self):  # noqa: E501
        """TranscodeReason - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TranscodeReason, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TranscodeReason):
            return False
