...
class ConfigurationUserConfiguration(object):
    ...
    def intro_skip_mode(self, intro_skip_mode):
        ...
        :type: str
        """
        allowed_values = ["ShowButton", "AutoSkip", "None"]  # noqa: E501
        if intro_skip_mode not in allowed_values:
            raise ValueError(
                "Invalid value for `intro_skip_mode` ({0}), must be one of {1}"  # noqa: E501
                .format(intro_skip_mode, allowed_values)
            )
