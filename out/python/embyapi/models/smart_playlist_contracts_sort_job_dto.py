...
class SmartPlaylistContractsSortJobDto(object):
    ...
    def __init__(self, enabled=None, update_type=None, order_by=None, sync_count=None, last_sync_duration=None, status=None, next_update=None, last_updated=None, last_ran=None, then_bys=None, last_duration_str=None):  # noqa: E501
        ...
        if then_bys is not None:
            self.then_bys = then_bys
    ...
    @property
    def then_bys(self):
        """Gets the then_bys of this SmartPlaylistContractsSortJobDto.  # noqa: E501


        :return: The then_bys of this SmartPlaylistContractsSortJobDto.  # noqa: E501
        :rtype: list[str]
        """
        return self._then_bys

    @then_bys.setter
    def then_bys(self, then_bys):
        """Sets the then_bys of this SmartPlaylistContractsSortJobDto.


        :param then_bys: The then_bys of this SmartPlaylistContractsSortJobDto.  # noqa: E501
        :type: list[str]
        """

        self._then_bys = then_bys
