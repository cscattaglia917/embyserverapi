...
class ProvidersSeriesInfo(object):
    ...
    def __init__(self, episode_air_date=None, name=None, metadata_language=None, metadata_country_code=None, provider_ids=None, year=None, index_number=None, parent_index_number=None, premiere_date=None, is_automated=None):  # noqa: E501
