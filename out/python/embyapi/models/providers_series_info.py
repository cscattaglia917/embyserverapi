...
class ProvidersSeriesInfo(object):
    ...
    def display_order(self, display_order):
        ...
        :type: str
        """
        allowed_values = ["Aired", "Dvd", "Absolute"]  # noqa: E501
        if display_order not in allowed_values:
            raise ValueError(
                "Invalid value for `display_order` ({0}), must be one of {1}"  # noqa: E501
                .format(display_order, allowed_values)
            )
